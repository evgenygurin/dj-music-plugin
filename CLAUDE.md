...
**Текущая версия:** v1.7.0 (детальная история — [CHANGELOG.md](CHANGELOG.md)).
...
This project is indexed by GitNexus as **dj-music-plugin** (9663 symbols, 16102 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
