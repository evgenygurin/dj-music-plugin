...
from app.server.middleware.structured_logging import (
...
async def test_logs_enter_and_exit(caplog) -> None:
    ...
    with caplog.at_level(logging.INFO, logger="app.server.middleware.structured_logging"):
...
async def test_logs_error(caplog) -> None:
    ...
    with (
        caplog.at_level(logging.INFO, logger="app.server.middleware.structured_logging"),
