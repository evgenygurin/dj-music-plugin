...
async def test_camelot_shape_and_content() -> None:
    from app.resources.reference.camelot import reference_camelot
...
async def test_subgenres_shape_and_content() -> None:
    from app.resources.reference.subgenres import reference_subgenres
...
async def test_templates_shape_and_content() -> None:
    from app.resources.reference.templates import reference_templates
...
async def test_audit_rules_shape_and_content() -> None:
    from app.resources.reference.audit_rules import reference_audit_rules
