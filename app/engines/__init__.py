# Compatibility shim: redirect all app.engines.X imports to dj_music.engines.X
import sys as _sys
...
class _AliasFinder(_Finder):
    ...
    def find_spec(self, fullname, path, target=None):  # type: ignore[override]
        if not fullname.startswith(self._PREFIX):
            return None
        canonical = "dj_music.engines." + fullname[len(self._PREFIX):]
...
_canonical_name = "dj_music.engines"
