"""Domain constants, enums, and static reference data (v2 fork).

Non-configurable values that define the system's vocabulary. Forked copy of
``app/core/constants.py`` per parallel-refactor policy (blueprint §15.7).
For tunable values, see ``app.v2.config``.
"""
