...
from app.models.track import Track, TrackAudioFeaturesComputed
...
async def score_track_transitions(
    ...
    for idx, (candidate_track, candidate_features) in enumerate(candidates):
        ...
        if progress and idx % 50 == 0:
            await progress.set_message(f"Scored {scored_count} / {total_candidates} transitions...")
