"""DJ set templates — 8 pre-defined energy arc definitions.

Each template defines slots with position, target mood, energy, BPM range,
duration, and flexibility. Used by the GA optimizer for template-aware fitness.
"""
