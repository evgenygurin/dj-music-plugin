...
class YandexMetadata(Base, TimestampMixin):
    ...
    album_year: Mapped[int | None] = mapped_column(Integer, nullable=True)
...
class SoundcloudMetadata(Base, TimestampMixin):
    ...
    playback_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    favoritings_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    reposts_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
