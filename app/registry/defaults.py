    ...
    EntityRegistry.register(
        EntityConfig(
            ...
            filterable_fields={
                ...
                "play_count": ("gte", "lte"),
                "positive_count": ("gte", "lte"),
                "negative_count": ("gte", "lte"),
            },
            sortable_fields=("id", "avg_score", "play_count"),
            relations={},
            tags=frozenset({"namespace:feedback"}),
        )
    )
    ...
    EntityRegistry.register(
        EntityConfig(
            ...
            filterable_fields={
                ...
                "name": ("eq", "icontains"),
                "bpm_weight": ("gte", "lte"),
                "harmonic_weight": ("gte", "lte"),
                "energy_weight": ("gte", "lte"),
                "spectral_weight": ("gte", "lte"),
                "groove_weight": ("gte", "lte"),
                "timbral_weight": ("gte", "lte"),
            },
