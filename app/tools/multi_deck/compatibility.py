...
@tool(
    name="stem_vertical_compatibility", annotations={"readOnlyHint": True, "idempotentHint": True}
)
async def stem_vertical_compatibility(
    ...
    return {
        ...
        "per_band": {
            band: {"score": bs.score, "clash": bs.clash, "culprits": bs.culprits}
            for band, bs in result.per_band.items()
        },
