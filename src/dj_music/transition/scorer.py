...
from dj_music.transition.components import (
    score_bpm,
    score_energy,
    score_groove,
    score_harmonic,
...
from dj_music.transition.intent import INTENT_WEIGHT_MODIFIERS, TransitionIntent
from dj_music.transition.score import TransitionScore
from dj_music.transition.section_context import SectionContext
from dj_music.transition.style import recommend_style, style_profile
from dj_music.transition.weights import DRUM_ONLY_WEIGHT_OVERRIDE
...
# `from dj_music.transition.scorer import recommend_style` calls
# remain valid.
