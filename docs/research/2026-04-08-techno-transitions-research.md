...
Этот документ — **обоснование**, не план. Конкретные изменения архитектуры пойдут в `docs/superpowers/specs/2026-04-08-transition-system-redesign.md`. Резюме того, что спека должна решить:
