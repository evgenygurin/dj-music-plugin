...
## 9. Полнота каталога — 26 промтов × ситуации
...
Жирным — 7 новых. Покрыты все три оси журналов (ключ/поджанр/темп), оба
направления построения (сверху-вниз шаблон / снизу-вверх кластеры),
полный спектр ремонта (пара / слот / весь сет), эстетика школ,
перформанс-артефакт и гигиена.

---

## 10. Лучшие практики FastMCP v3+ (применены к 7 новым промтам)
