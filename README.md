...
**v1.11.0** · MIT · MCP-сервер для управления личной DJ techno библиотекой, построения оптимизированных DJ сетов и интеграции с Яндекс Музыкой.
...
```bash
claude plugin marketplace add https://github.com/evgenygurin/dj-music-plugin.git#v1.11.0
```
